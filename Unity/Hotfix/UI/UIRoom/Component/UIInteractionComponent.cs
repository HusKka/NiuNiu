...
{
    [ObjectSystem]
    public class UIInteractionComponentAwakeSystem : AwakeSystem<UIInteractionComponent>
    {
        public override void Awake(UIInteractionComponent self)
        {
            self.Awake();
        }
    }

    public class UIInteractionComponent : Component
    {
        ...
        public override void Dispose()
        {
            ...
            ETModel.Game.Scene.GetComponent<ResourcesComponent>()?.UnloadBundle($"{UIType.UIInteraction}.unity3d");
        }
