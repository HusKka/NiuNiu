...
{
    [ObjectSystem]
    public class UIEndComponentAwakeSystem : AwakeSystem<UIEndComponent, bool>
    {
        public override void Awake(UIEndComponent self, bool isWin)
        {
            self.Awake(isWin);
        }
    }
    ...
    public class UIEndComponent : Component
    {
        ...
        public override void Dispose()
        {
            ...
            resourcesComponent?.UnloadBundle($"{UIType.UIEnd}.unity3d");
        }
